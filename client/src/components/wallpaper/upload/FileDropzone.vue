...
.file-input-display.drag-over { border-color: #007bff; background: rgba(0, 123, 255, 0.04); }
.file-input-display:hover { border-color: #007bff; }
.file-input-display small { color: #666; font-size: 12px; margin-top: 8px; display: block; }
</style>
