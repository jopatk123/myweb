  ...
  <div class="settings-panel">
    ...
    <div class="setting-item">
      ...
      <div class="color-picker">
        <input 
          v-model="localSettings.avatarColor" 
          type="color"
        />
        <button @click="randomizeColor" class="random-color-btn">
          🎲
        </button>
      </div>
    </div>
    <div class="setting-item">
      <label>
        <input 
          v-model="localSettings.autoOpenEnabled" 
          type="checkbox"
        />
        自动打开新消息
      </label>
...
const emit = defineEmits(['update:modelValue', 'save', 'cancel', 'request-clear']);
