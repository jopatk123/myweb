<template>
  <div class="shared-game-panel">
    ...
    <VoteButtons :current-vote="myVote" mode="shared" @vote="$emit('vote', $event)" />
  </div>
</template>
<script setup>
...
<style scoped>
.shared-game-panel{display:flex;flex-direction:column;align-items:center;gap:8px;}
.game-canvas{background:#111;border:3px solid #333;border-radius:8px;image-rendering:pixelated;}
.score-bar{display:flex;gap:16px;font-size:14px;font-weight:600;color:#444;}
</style>
