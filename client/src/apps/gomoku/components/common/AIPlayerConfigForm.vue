<template>
  <div class="player-config">
    ...
    <div class="preset-section" v-if="presetConfigs && presetConfigs.length">
      <label>预设配置:</label>
      <select
        @change="e => handlePreset(e.target.value)"
        :value="''"
        class="preset-select"
      >
    ...
    <div class="config-form">
      ...
      <div class="form-group">
        ...
        <input
          type="text"
          v-model="modelValue.playerName"
          :placeholder="`AI玩家${playerNumber}`"
        />
      </div>

      <div class="form-actions">
        <button
          @click="emit('test', playerNumber)"
          :disabled="isTesting"
      ...
      <div v-if="testResult" class="test-result">
        <div
          :class="['result-message', testResult.success ? 'success' : 'error']"
        >
          {{ testResult.message }}
        </div>
      </div>
