  ...
  <div class="prompt-template-selector">
    ...
    <div v-if="selectedTemplate" class="template-preview">
      ...
      <div class="template-actions">
        ...
        <button @click="resetTemplate" class="btn btn-muted btn-sm">
          重置
        </button>
        <button @click="openCustomTemplateForm" class="btn btn-info btn-sm">
          添加自定义
        </button>
      </div>
    </div>
    ...
    <div v-if="showCustomForm" class="custom-template-form">
      ...
      <div class="form-actions">
        <button @click="confirmAddTemplate" class="btn btn-success btn-sm">
          确认添加
        </button>
        <button @click="cancelAddTemplate" class="btn btn-muted btn-sm">
          取消
        </button>
      </div>
    </div>
...
<script setup>
  ...
  const { selectedTemplate, templateList, getTemplateInfo, addCustomTemplate } =
    useAIPrompts();
