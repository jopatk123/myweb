<template>
  <div class="thinking-history">
    <div class="history-header">
      <h5>💭 思考历史 <span class="record-count">({{ thinkingHistory.length }})</span></h5>
      <button v-if="thinkingHistory.length > 0" @click="$emit('clear-history')" class="clear-btn">清空</button>
    </div>
...
// 监听思考历史变化，自动滚动到底部
watch(() => props.thinkingHistory.length, async () => {
