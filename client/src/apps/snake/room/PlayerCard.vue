  ...
  >
    ...
    <div class="player-info">
      <div class="player-name">
        {{ player.player_name }}
        <span v-if="room?.created_by === player.session_id" class="host-badge">👑</span>
    ...
    <!-- 房主踢人按钮 -->
    <div v-if="room?.created_by === currentPlayer?.session_id && player.session_id !== currentPlayer?.session_id" class="player-actions">
      <button 
        class="kick-btn"
