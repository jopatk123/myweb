<template>
  <div class="game-controls">
    <div class="control-buttons">
      <button class="btn btn-secondary" @click="$emit('start')" :disabled="gameStarted && !gameOver">
        {{ gameStarted && !gameOver ? '游戏中...' : '开始' }}
      </button>
      <button class="btn btn-secondary" @click="$emit('pause')" :disabled="!gameStarted || gameOver">
        {{ paused ? '继续' : '暂停' }}
      </button>
      <button class="btn btn-secondary" @click="$emit('restart')">重新开始</button>
    </div>
