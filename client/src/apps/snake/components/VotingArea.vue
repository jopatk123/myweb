    ...
    <div class="vote-buttons">
      ...
      <div class="vote-row">
        <button
          ...
          :class="{
            voted: myVote === 'left',
            winning: isWinningDirection('left'),
          }"
        ...
        <button
          ...
          :class="{
            voted: myVote === 'right',
            winning: isWinningDirection('right'),
          }"
      ...
      <div class="vote-row">
        <button
          ...
          :class="{
            voted: myVote === 'down',
            winning: isWinningDirection('down'),
          }"
...
<script setup>
  ...
  const getVoteCount = direction => {
    return Object.values(props.votes).filter(
      vote => vote.direction === direction
    ).length;
  };
