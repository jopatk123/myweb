...
export function createWallpaperRoutes(db) {
  ...
  router.put('/:id(\\d+)', (req, res, next) => controller.updateWallpaper(req, res, next));
  router.put('/:id(\\d+)/active', (req, res, next) => controller.setActiveWallpaper(req, res, next));
  router.delete('/:id(\\d+)', (req, res, next) => controller.deleteWallpaper(req, res, next));
